...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/22 00:19:12 by mmorot            #+#    #+#             */
/*   Updated: 2025/01/22 00:19:12 by mmorot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_info(t_texture_info *info, t_vector2 position, int img_size[2],
		t_layer *layer)
{
		...
		char *xpm_path)
{
	...
	if (!data && (mlx_destroy_image(mlx, img) || 1))
		return ;
	init_info(&info, position, img_size, layer);
